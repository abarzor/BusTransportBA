...
namespace BusTransport.DataAccess.Migrations
{
    ...
    [Migration("20240112162806_dataSeedBusstopDiscount")]
    partial class dataSeedBusstopDiscount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusTransport.Model.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Ticket_Id = 1,
                            DepartureDate = new DateTime(2024, 1, 12, 17, 28, 6, 31, DateTimeKind.Local).AddTicks(8495),
                            Discount_Id = 1,
                        ...
                        {
                            Ticket_Id = 2,
                            DepartureDate = new DateTime(2024, 1, 12, 17, 28, 6, 31, DateTimeKind.Local).AddTicks(8561),
                            Discount_Id = 2,
                            EndStop = "przystanek 1",
                            IsVaild = false,
                            Passenger_Id = 2,
