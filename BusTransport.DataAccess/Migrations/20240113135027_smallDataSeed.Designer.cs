...
namespace BusTransport.DataAccess.Migrations
{
    ...
    [Migration("20240113135027_smallDataSeed")]
    partial class smallDataSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusTransport.Model.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Ticket_Id = 1,
                            DepartureDate = new DateTime(2024, 1, 13, 14, 50, 26, 137, DateTimeKind.Local).AddTicks(1533),
                            Discount_Id = 1,
                        ...
                        {
                            Ticket_Id = 2,
                            DepartureDate = new DateTime(2024, 1, 13, 14, 50, 26, 137, DateTimeKind.Local).AddTicks(1613),
                            Discount_Id = 2,
                            EndStop = "przystanek 1",
                            IsVaild = false,
                            Passenger_Id = 2,
