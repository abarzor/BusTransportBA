    ...
    public partial class AddedIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RouteStop_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteStopps", x => x.RouteStop_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeatsOfBus_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatsOfBuses", x => x.SeatsOfBus_Id);
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Buses_Courses_CourseId",
                table: "Buses",
                column: "CourseId",
