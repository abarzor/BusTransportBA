...
namespace BusTransport.DataAccess.Migrations
{
    ...
    [Migration("20231107211630_oneToOne_CourseBus")]
    partial class oneToOne_CourseBus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusTransport.Model.Models.Bus", b =>
                {
                    b.HasOne("BusTransport.Model.Models.Course", "Course")
                        .WithOne("Bus")
                        .HasForeignKey("BusTransport.Model.Models.Bus", "Bus_Id")
            ...
            modelBuilder.Entity("BusTransport.Model.Models.Route", b =>
                {
                    b.HasOne("BusTransport.Model.Models.Course", "Course")
                        .WithOne("Route")
                        .HasForeignKey("BusTransport.Model.Models.Route", "Route_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
